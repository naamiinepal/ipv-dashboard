  ...
  <div>
    ...
    <div className="ml-16 mt-3 w-11/12 text-center">
      ...
      <div className="text-justify mt-3">
        ...
        conversation and trends surrounding the COVID-19 epidemic. We categorize
        the tweets across nine curated (mapped from WHO) topics using a MuRIL
        model to summarize our insights. Experimental results reveal the essence
        of our model as it can classify the tweets with appropriate scores for
        the evaluation metrics. The analysis of the results shows that our model
        can portray the growth in the discussions relating to different phases
        of the epidemic.
      </div>
      <Teams />
    </div>
